...
%independent Binomial random variables (sampled twice) with chromosome 22 maf
...
n=length(maf); %number of parameter 
...
G=G_Binomial(m,n,miss,miss_value,maf); 
...
save('syn_data_ex1','G','miss_value','x','y','h2') 
clear
load('syn_data_ex1') %uncomment this line and comment the above, if reusing the synthetic data
